...
image_file = "images/boxing_image.png"  # <--- Replace with your actual image file name
...
st.subheader("Welcome to the Boxing page!🥊 Here, you'll learn the basics of boxing in a safe and fun way. From how to stand and move, to throwing your first punches, this page will help you build strength, confidence, and focus — all while having a great time!", divider="gray")
...
with col1:
    st.image("images/boxingmatch_image.jpg", caption="Standard boxing match", width=550)

with col2:
    st.image("images/boxingkids_image.jpg", caption="child boxing", width=550)